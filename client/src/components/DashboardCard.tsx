...
export default async function DashboardCard() {
  ...
  return (
    <div className="card flex flex-col justify-center gap-4 absolute p-4 mx-5 h-52 bg-primaryDark top-28 left-0 right-0 rounded-3xl shadow-sm shadow-gray-200">
